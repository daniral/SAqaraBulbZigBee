...
$Record['TITLE']='Цвет';
$Record['PARENT_ID']=$insertID;
$Record['SUB_LIST']=($insertID+19).",".($insertID+20).",".($insertID+21).",".($insertID+22);
$Record['PARENT_LIST']=$insertID;
$Record['PRIORITY']=10;
$Record['SUB_PRELOAD']=1;
...
$Record['TITLE']='Яркость Днем';
$Record['PARENT_ID']=($insertID+18);
$Record['SUB_LIST']=($insertID+19);
$Record['PARENT_LIST']=$insertID;
$Record['PRIORITY']=40;
...
$Record['TITLE']='Температура Ночью';
$Record['PARENT_ID']=($insertID+18);
