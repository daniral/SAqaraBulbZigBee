...
$this->device_types['SAqaraBulb'] = array(
	...
	'METHODS' => array(
		...
		'brightnessDown' => array('DESCRIPTION' => 'Уменьшить яркость.(array(\'value\'=>1-50)) Без параметров -10.', '_CONFIG_SHOW' => 1),
		'brightnessUp' => array('DESCRIPTION' => 'Увеличить яркость.(array(\'value\'=>1-50)) Без параметров +10.', '_CONFIG_SHOW' => 1),
		'colorDown' => array('DESCRIPTION' => 'Уменьшить температуру.(array(\'value\'=>1-50)) Без параметров -10.', '_CONFIG_SHOW' => 1),
		'colorUp' => array('DESCRIPTION' => 'Увеличить температуру.(array(\'value\'=>1-50)) Без параметров +10.', '_CONFIG_SHOW' => 1),
		'byDefault' => array('DESCRIPTION' => 'Установить свойства по умолчанию.'),
		'colorPreset' => array('DESCRIPTION' => 'Цветовые пресеты.(array(\'value\'=>\'C\'-cold,\'N\'-neutral,\'W\'-warmest))', '_CONFIG_SHOW' => 1),
		...
		'setBrightness' => array('DESCRIPTION' => 'Установить яркость света.(array(\'value\'=> brightnessMin<-->brightnessMax)) Без  параметров то что в brightness_seved. Если brightness_seved пусто то brightnessMax.', '_CONFIG_SHOW' => 1),
		'setColor' => array('DESCRIPTION' => 'Установить температуру.(array(\'value\'=>color_tempMin <--> color_tempMax)) Без  параметров то что в color_seved. Если color_seved пуст то холодный color_tempMin.', '_CONFIG_SHOW' => 1),
		...
		'brightnessChanged' => array('DESCRIPTION' => 'Запускается при смене яркости', '_CONFIG_SHOW' => 1),
		'colorChanged' => array('DESCRIPTION' => 'Запускается при смене цвета температуры', '_CONFIG_SHOW' => 1),
	),
);
