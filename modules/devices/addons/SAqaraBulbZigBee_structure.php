...
$this->device_types['SAqaraBulb'] = array(
        ...
        'PROPERTIES' => array(
			...
			'brightness' => array('DESCRIPTION' => 'Яркость (brightnessMin<-->brightnessMax)', 'DATA_KEY' => 1),
            ...
            'color_temp' => array('DESCRIPTION' => 'Цветовая температура: (color_tempMin<-->color_tempMax)', 'DATA_KEY' => 1),
